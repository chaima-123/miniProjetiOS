...
class DemClientViewController:UIViewController , UITableViewDataSource,UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        labelName.text = services[indexPath.row].prestatire_name
    ...
    @objc fileprivate func fetchServices() {
        ...
        {
        Service.shared.showServiceClient(client_id:UserDefaults.standard.integer(forKey: "id_user")){(res) in
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let dest = segue.destination as? DemandeDetailViewController
